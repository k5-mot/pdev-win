# cygwin-integration Specification

## Purpose
Define optional Cygwin installation behavior, mirror selection, no-admin setup flags, packages, installation location, and Cygwin launcher behavior.
## Requirements
